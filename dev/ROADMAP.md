...
## v0.2.0 -- exact search + top-k + `Index` impl (THE HARD PART, NOT DEFERRED)
...
## v0.3.0 -- rayon parallel scans + contiguous memory layout
...
## v0.4.0 -- metadata pre-filter integration + feature freeze
